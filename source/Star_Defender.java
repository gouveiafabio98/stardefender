...
public class Star_Defender extends PApplet {
...
int dica=PApplet.parseInt(random(1, 4));
float angle;
...
int ag1x=PApplet.parseInt(random(900, 1500));
int ag2x=PApplet.parseInt(random(900, 1500));
int ag3x=PApplet.parseInt(random(900, 1500));
int am1x=PApplet.parseInt(random(900, 1500));
int am2x=PApplet.parseInt(random(900, 1500));
int am3x=PApplet.parseInt(random(900, 1500));
int ap1x=PApplet.parseInt(random(900, 1500));
int ap2x=PApplet.parseInt(random(900, 1500));
int ap3x=PApplet.parseInt(random(900, 1500));
int ag1y=PApplet.parseInt(random(1, 600));
int ag2y=PApplet.parseInt(random(1, 600));
int ag3y=PApplet.parseInt(random(1, 600));
int am1y=PApplet.parseInt(random(1, 650));
int am2y=PApplet.parseInt(random(1, 650));
int am3y=PApplet.parseInt(random(1, 650));
int ap1y=PApplet.parseInt(random(1, 675));
int ap2y=PApplet.parseInt(random(1, 675));
int ap3y=PApplet.parseInt(random(1, 675));

int ag1x1=PApplet.parseInt(random(900, 1500));
int ag2x1=PApplet.parseInt(random(900, 1500));
int ag3x1=PApplet.parseInt(random(900, 1500));
int am1x1=PApplet.parseInt(random(900, 1500));
int am2x1=PApplet.parseInt(random(900, 1500));
int am3x1=PApplet.parseInt(random(900, 1500));
int ap1x1=PApplet.parseInt(random(900, 1500));
int ap2x1=PApplet.parseInt(random(900, 1500));
int ap3x1=PApplet.parseInt(random(900, 1500));
int ag1y1=PApplet.parseInt(random(1, 600));
int ag2y1=PApplet.parseInt(random(1, 600));
int ag3y1=PApplet.parseInt(random(1, 600));
int am1y1=PApplet.parseInt(random(1, 650));
int am2y1=PApplet.parseInt(random(1, 650));
int am3y1=PApplet.parseInt(random(1, 650));
int ap1y1=PApplet.parseInt(random(1, 675));
int ap2y1=PApplet.parseInt(random(1, 675));
int ap3y1=PApplet.parseInt(random(1, 675));
...
int explosaoboss=0;
int bossmusica=0;
int xpoweruptiro=PApplet.parseInt(random(1500, 4000));
int xpowerupnave=PApplet.parseInt(random(1500, 4000));
int xpoweruptransparente=PApplet.parseInt(random(1500, 4000));
int ypoweruptiro=PApplet.parseInt(random(0, 665));
int ypowerupnave=PApplet.parseInt(random(0, 665));
int ypoweruptransparente=PApplet.parseInt(random(0, 665));
...
public void draw() {
  ...
  if (a==6) {
    ...
    ag1x=PApplet.parseInt(random(900, 1500));
    ag2x=PApplet.parseInt(random(900, 1500));
    ag3x=PApplet.parseInt(random(900, 1500));
    am1x=PApplet.parseInt(random(900, 1500));
    am2x=PApplet.parseInt(random(900, 1500));
    am3x=PApplet.parseInt(random(900, 1500));
    ap1x=PApplet.parseInt(random(900, 1500));
    ap2x=PApplet.parseInt(random(900, 1500));
    ap3x=PApplet.parseInt(random(900, 1500));
    ag1x1=PApplet.parseInt(random(900, 1500));
    ag2x1=PApplet.parseInt(random(900, 1500));
    ag3x1=PApplet.parseInt(random(900, 1500));
    am1x1=PApplet.parseInt(random(900, 1500));
    am2x1=PApplet.parseInt(random(900, 1500));
    am3x1=PApplet.parseInt(random(900, 1500));
    ap1x1=PApplet.parseInt(random(900, 1500));
    ap2x1=PApplet.parseInt(random(900, 1500));
    ap3x1=PApplet.parseInt(random(900, 1500));
    ag1y=PApplet.parseInt(random(1, 600));
    ag2y=PApplet.parseInt(random(1, 600));
    ag3y=PApplet.parseInt(random(1, 600));
    am1y=PApplet.parseInt(random(1, 650));
    am2y=PApplet.parseInt(random(1, 650));
    am3y=PApplet.parseInt(random(1, 650));
    ap1y=PApplet.parseInt(random(1, 675));
    ap2y=PApplet.parseInt(random(1, 675));
    ap3y=PApplet.parseInt(random(1, 675));
    ag1y1=PApplet.parseInt(random(1, 600));
    ag2y1=PApplet.parseInt(random(1, 600));
    ag3y1=PApplet.parseInt(random(1, 600));
    am1y1=PApplet.parseInt(random(1, 650));
    am2y1=PApplet.parseInt(random(1, 650));
    am3y1=PApplet.parseInt(random(1, 650));
    ap1y1=PApplet.parseInt(random(1, 675));
    ap2y1=PApplet.parseInt(random(1, 675));
    ap3y1=PApplet.parseInt(random(1, 675));
...
public void distancia() {
  if (nivel!=6) {
    if (xpowerupnave>=0 && xpowerupnave<=100 && ypowerupnave>=fogy && ypowerupnave<=fogy+100) {
      tempopowernave=300;
      xpowerupnave=PApplet.parseInt(random(1500, 4000));
      ypowerupnave=PApplet.parseInt(random(0, 665));
    }
    if (xpoweruptiro>=0 && xpoweruptiro<=100 && ypoweruptiro>=fogy && ypoweruptiro<=fogy+100) {
      tempopowertiro=300;
      xpoweruptiro=PApplet.parseInt(random(1500, 4000));
      ypoweruptiro=PApplet.parseInt(random(0, 665));
    }
    if (xpoweruptransparente>=0 && xpoweruptransparente<=100 && ypoweruptransparente>=fogy && ypoweruptransparente<=fogy+100) {
      ...
      xpoweruptransparente=PApplet.parseInt(random(1500, 4000));
      ypoweruptransparente=PApplet.parseInt(random(0, 665));
    }
    ...
    if (xpowerupnave<-50) {
      xpowerupnave=PApplet.parseInt(random(1400, 4000));
      ypowerupnave=PApplet.parseInt(random(0, 665));
    }
    if (xpoweruptransparente<-50) {
      xpoweruptransparente=PApplet.parseInt(random(1400, 4000));
      ypoweruptransparente=PApplet.parseInt(random(0, 665));
    }
  }
  if (distancia==1000) {
  ...
  case ENTER:
    ...
    if (a==7) {
      ...
      if (xpowerupnave<900 && xpowerupnave>0) {
        xpowerupnave=PApplet.parseInt(random(900, 1500));
      }
      if (xpoweruptiro<900 && xpoweruptiro>0) {
        xpoweruptiro=PApplet.parseInt(random(900, 1500));
      }
      if (xpoweruptransparente<900 && xpoweruptransparente>0) {
        xpoweruptransparente=PApplet.parseInt(random(900, 1500));
      }
    }
    if (a==8) {
      a=0;
...
public void colisaotiros() {
  ...
  if (ytiro+5>ag1y && ytiro+5<ag1y+100 && xtiro>=ag1x &&(nivel==2 || nivel==3 || nivel==4 || nivel==5  )) {
    ...
    ytiro=9999;
    ag1x=PApplet.parseInt(random(900, 1500)); 
    ag1y=PApplet.parseInt(random(900, 1500));
    ag1xk=0;
    player3.play();
    player3.rewind();
  }
  ...
  if (ytiro+5>am1y && ytiro+5<am1y+50 && xtiro>=am1x &&(nivel==1 || nivel==2 || nivel==3 || nivel==4 || nivel==5 ) ) {
    ...
    ytiro=9999;
    am1x=PApplet.parseInt(random(900, 1500)); 
    am1y=PApplet.parseInt(random(900, 1500)); 
    am1xk=0;
    player3.play();
    player3.rewind();
  }
  ...
  if (ytiro+5>ap1y && ytiro+5<ap1y+25 && xtiro>=ap1x &&(nivel==1 || nivel==2 || nivel==3 || nivel==4 || nivel==5) ) {
    ...
    ytiro=9999;
    ap1x=PApplet.parseInt(random(900, 1500)); 
    ap1y=PApplet.parseInt(random(900, 1500));
    ap1xk=0;
    player3.play();
    player3.rewind();
  }
  ...
  if (ytiro+5>ag2y && ytiro+5<ag2y+100 && xtiro>=ag2x &&(nivel==2 || nivel==3  || nivel==4 || nivel==5 )) {
    ...
    ytiro=9999;
    ag2x=PApplet.parseInt(random(900, 1500));
    ag2y=PApplet.parseInt(random(900, 1500));
    ag2xk=0;
    player3.play();
    player3.rewind();
  }
  ...
  if (ytiro+5>am2y && ytiro+5<am2y+50 && xtiro>=am2x &&(nivel==1 || nivel==2 || nivel==3 || nivel==4  || nivel==5 ) ) {
    ...
    ytiro=9999;
    am2x=PApplet.parseInt(random(900, 1500));
    am2y=PApplet.parseInt(random(900, 1500));
    am2xk=0;
    player3.play();
    player3.rewind();
  }
  ...
  if (ytiro+5>ap2y && ytiro+5<ap2y+25 && xtiro>=ap2x &&(nivel==1 || nivel==2 || nivel==3 || nivel==4 || nivel==5) ) {
    ...
    ytiro=9999;
    ap2x=PApplet.parseInt(random(900, 1500)); 
    ap2y=PApplet.parseInt(random(900, 1500)); 
    ap2xk=0;
    player3.play();
    player3.rewind();
  }
  ...
  if (ytiro+5>ag3y && ytiro+5<ag3y+100 && xtiro>=ag3x &&(nivel==2 || nivel==3  || nivel==4  || nivel==5)) {
    ...
    ytiro=9999;
    ag3x=PApplet.parseInt(random(900, 1500));
    ag3y=PApplet.parseInt(random(900, 1500));
    ag3xk=0;
    player3.play();
    player3.rewind();
  }
  ...
  if (ytiro+5>am3y && ytiro+5<am3y+50 && xtiro>=am3x &&(nivel==1 || nivel==3 || nivel==4  || nivel==5 )) {
    ...
    ytiro=9999;
    am3x=PApplet.parseInt(random(900, 1500)); 
    am3y=PApplet.parseInt(random(900, 1500)); 
    am3xk=0;
    player3.play();
    player3.rewind();
  }
  ...
  if (ytiro+5>ap3y && ytiro+5<ap3y+25 && xtiro>=ap3x &&(nivel==1 || nivel==2 || nivel==3 || nivel==4 || nivel==5) ) {
    ...
    ytiro=9999;
    ap3x=PApplet.parseInt(random(900, 1500)); 
    ap3y=PApplet.parseInt(random(900, 1500)); 
    ap3xk=0;
    player3.play();
    player3.rewind();
  }
  ...
  if (ytiro+5>ag1y1 && ytiro+5<ag1y1+100 && xtiro>=ag1x1 && (nivel==3  || nivel==4 || nivel==5  ) ) {
    ...
    ytiro=9999;
    ag1x1=PApplet.parseInt(random(900, 1500)); 
    ag1y1=PApplet.parseInt(random(900, 1500)); 
    ag1x1k=0;
    player3.play();
    player3.rewind();
  }
  ...
  if (ytiro+5>am1y1 && ytiro+5<am1y1+50 && xtiro>=am1x1 &&(nivel==1  || nivel==3 || nivel==4  || nivel==5 )) {
    ...
    ytiro=9999;
    am1x1=PApplet.parseInt(random(900, 1500)); 
    am1y1=PApplet.parseInt(random(900, 1500)); 
    am1x1k=0;
    player3.play();
    player3.rewind();
  }
  ...
  if (ytiro+5>ap1y1 && ytiro+5<ap1y1+25 && xtiro>=ap1x1 &&(nivel==1 || nivel==2  || nivel==5) ) {
    ...
    ytiro=9999;
    ap1x1=PApplet.parseInt(random(900, 1500)); 
    ap1y1=PApplet.parseInt(random(900, 1500)); 
    ap1x1k=0;
    player3.play();
    player3.rewind();
  }
  ...
  if (ytiro+5>ag2y1 && ytiro+5<ag2y1+100 && xtiro>=ag2x1 &&( nivel==4  || nivel==5  )) {
    ...
    ytiro=9999;
    ag2x1=PApplet.parseInt(random(900, 1500));
    ag2y1=PApplet.parseInt(random(900, 1500));
    ag2x1k=0;
    player3.play();
    player3.rewind();
  }
  ...
  if (ytiro+5>am2y1 && ytiro+5<am2y1+50 && xtiro>=am2x1 &&(nivel==1  || nivel==5) ) {
    ...
    ytiro=9999;
    am2x1=PApplet.parseInt(random(900, 1500));
    am2y1=PApplet.parseInt(random(900, 1500));
    am2x1k=0;
    player3.play();
    player3.rewind();
  }
  ...
  if (ytiro+5>ap2y1 && ytiro+5<ap2y1+25 && xtiro>=ap2x1 &&(nivel==1  || nivel==5 )) {
    ...
    ytiro=9999;
    ap2x1=PApplet.parseInt(random(900, 1500));
    ap2y1=PApplet.parseInt(random(900, 1500));
    ap2x1k=0;
    player3.play();
    player3.rewind();
  }
  ...
  if (ytiro+5>ag3y1 && ytiro+5<ag3y1+100 && xtiro>=ag3x1 &&( nivel==5)) {
    ...
    ytiro=9999;
    ag3x1=PApplet.parseInt(random(900, 1500));
    ag3y1=PApplet.parseInt(random(900, 1500)); 
    ag3x1k=0;
    player3.play();
    player3.rewind();
  }
  ...
  if (ytiro+5>am3y1 && ytiro+5<am3y1+50 && xtiro>=am3x1 &&(nivel==1 || nivel==5 ) ) {
    ...
    ytiro=9999;
    am3x1=PApplet.parseInt(random(900, 1500)); 
    am3y1=PApplet.parseInt(random(900, 1500)); 
    am3x1k=0;
    player3.play();
    player3.rewind();
  }
  ...
  if (ytiro+5>ap3y1 && ytiro+5<ap3y1+25 && xtiro>=ap3x1 &&(nivel==1 || nivel==5 ) ) {
    ...
    ytiro=9999;
    ap3x1=PApplet.parseInt(random(900, 1500));
    ap3y1=PApplet.parseInt(random(900, 1500));
    ap3x1k=0;
    player3.play();
    player3.rewind();
  }
...
public void asteroids() {
  ...
  if (ag1x<-50) {
    ag1x=PApplet.parseInt(random(900, 1500));
    ag1y=PApplet.parseInt(random(0, 600));
  }
  if (am1x<-50) {
    am1x=PApplet.parseInt(random(900, 1500));
    am1y=PApplet.parseInt(random(0, 600));
  }
  if (ap1x<-50) {
    ap1x=PApplet.parseInt(random(900, 1500));
    ap1y=PApplet.parseInt(random(0, 600));
  }
  if (ag2x<-50) {
    ag2x=PApplet.parseInt(random(900, 1500));
    ag2y=PApplet.parseInt(random(0, 650));
  }
  if (am2x<-50) {
    am2x=PApplet.parseInt(random(900, 1500));
    am2y=PApplet.parseInt(random(0, 650));
  }
  if (ap2x<-50) {
    ap2x=PApplet.parseInt(random(900, 1500));
    ap2y=PApplet.parseInt(random(0, 650));
  }
  if (ag3x<-50) {
    ag3x=PApplet.parseInt(random(900, 1500));
    ag3y=PApplet.parseInt(random(0, 675));
  }
  if (am3x<-50) {
    am3x=PApplet.parseInt(random(900, 1500));
    am3y=PApplet.parseInt(random(0, 675));
  }
  if (ap3x<-50) {
    ap3x=PApplet.parseInt(random(900, 1500));
    ap3y=PApplet.parseInt(random(0, 675));
  }
  ...
  if (ag1x1<-50) {
    ag1x1=PApplet.parseInt(random(900, 1500));
    ag1y1=PApplet.parseInt(random(0, 600));
  }
  if (am1x1<-50) {
    am1x1=PApplet.parseInt(random(900, 1500));
    am1y1=PApplet.parseInt(random(0, 600));
  }
  if (ap1x1<-50) {
    ap1x1=PApplet.parseInt(random(900, 1500));
    ap1y1=PApplet.parseInt(random(0, 600));
  }
  if (ag2x1<-50) {
    ag2x1=PApplet.parseInt(random(900, 1500));
    ag2y1=PApplet.parseInt(random(0, 650));
  }
  if (am2x1<-50) {
    am2x1=PApplet.parseInt(random(900, 1500));
    am2y1=PApplet.parseInt(random(0, 650));
  }
  if (ap2x1<-50) {
    ap2x1=PApplet.parseInt(random(900, 1500));
    ap2y1=PApplet.parseInt(random(0, 650));
  }
  if (ag3x1<-50) {
    ag3x1=PApplet.parseInt(random(900, 1500));
    ag3y1=PApplet.parseInt(random(0, 675));
  }
  if (am3x1<-50) {
    am3x1=PApplet.parseInt(random(900, 1500));
    am3y1=PApplet.parseInt(random(0, 675));
  }
  if (ap3x1<-50) {
    ap3x1=PApplet.parseInt(random(900, 1500));
    ap3y1=PApplet.parseInt(random(0, 675));
  }
  ...
  if (a==6) {
    if (mouseX>700 && mouseX<900 && mouseY>660 && mouseY<700 && tempocontinuar==0) {
      if (nivel==6) {
        ...
        a=8;
        dica=PApplet.parseInt(random(1, 4));
        fogy=300;
        xtiro=100;
        xtiro1=100;
        tempopause=0;
...
public void mouseDragged() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Star_Defender" };
    if (passedArgs != null) {
